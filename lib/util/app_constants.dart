...
class AppConstants {
  static const String APP_NAME = 'Caters';
  static const double APP_VERSION = 1.0;

  // static const String BASE_URL = 'https://stackfood-admin.6amtech.com';
  static const String BASE_URL = 'https://indiacaters.com';
  static const String send_otp = '/api/v1/auth/send_otp';
  static const String fetch_detail = '/api/v1/auth/fetch_detail';
  ...
  static const String RUNNING_SUBSCRIPTION_ORDER_LIST_URI = '/api/v1/customer/order/order-subscription-list';
  ...
  static const String RECENTLY_VIEWED_RESTAURANT_URI = '/api/v1/restaurants/recently-viewed-restaurants';
  static const String SUBSCRIPTION_LIST_URL = '/api/v1/customer/subscription';
  static const String SEND_CHECKOUT_NOTIFICATION_URL = '/api/v1/customer/order/send-notification';
