...
class ApiClient extends GetxService {
  ...
  ApiClient({required this.appBaseUrl, required this.sharedPreferences}) {
    ...
    try {
      final addressJson = sharedPreferences!.getString(AppConstants.USER_ADDRESS);
      if (addressJson != null) {
    ...
    updateHeader(
      token,
      _addressModel?.zoneIds,
      sharedPreferences!.getString(AppConstants.LANGUAGE_CODE),
      _addressModel?.latitude?.toString(),
      _addressModel?.longitude?.toString(),
    );
  }
  ...
  void updateHeader(String? token, List<int>? zoneIDs, String? languageCode, String? latitude, String? longitude) {
    ...
    if (zoneIDs != null) {
      _mainHeaders[AppConstants.ZONE_ID] = jsonEncode(zoneIDs);
    }
    if (latitude != null) {
      _mainHeaders[AppConstants.LATITUDE] = jsonEncode(latitude);
    }
    if (longitude != null) {
      _mainHeaders[AppConstants.LONGITUDE] = jsonEncode(longitude);
    }
  }
