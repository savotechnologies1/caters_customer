...
class AuthRepo {
  ...
  Future<Response> sendOtp(String phone) async {
    return await apiClient!.postData(AppConstants.send_otp, {"phone": phone});
  }
  Future<Response> loginWithNumber(String phone) async {
    return await apiClient!.postData(AppConstants.fetch_detail, {"phone": phone});
  }
  ...
  Future<Response> registerRestaurant(RestaurantBody restaurant, XFile logo,
      XFile cover, XFile fssaiImage, XFile panImage, XFile gstImage) async {
    return apiClient!.postMultipartData(
      ...
      [
        ...
        MultipartBody('fssai_image', fssaiImage),
        MultipartBody('pancard_image', panImage),
        MultipartBody('gstIn_image', gstImage)
      ],
    );
  }
