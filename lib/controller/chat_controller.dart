...
class ChatController extends GetxController implements GetxService {
    ...
    if (_response != null && _response.body!['messages'] != {} && _response!.statusCode == 200) {
      if (offset == 1) {
        ...
        if (notificationBody != null && notificationBody.adminId != null) {
          ...
          _sortMessage(0); // default admin id ya safe value
        }
      }else {
  ...
  @required int? conversationID, @required int ?index}) async {
    ...
    if(notificationBody == null || notificationBody.adminId != null) {
      _response = await chatRepo!.sendMessage(message!, _myImages, 0, UserType.admin,0 );
    } else if(notificationBody.restaurantId != null) {
    ...
    if (_response!.statusCode == 200) {
      ...
      if (notificationBody != null && notificationBody.adminId != null) {
        ...
        _sortMessage(0); // ya koi default safe id
      }
  ...
  void reloadConversationWithNotification(int conversationID) {
    ...
    _conversation!.unreadMessageCount!+1;
  ...
  //   );
  //
  //   final sizeMB = input.sizeInBytes / 1048576;
  //
  //   final config = Configuration(
  //     outputType: ImageOutputType.webpThenPng,
  //     useJpgPngNativeCompressor: false,
  //     quality: sizeMB < 2 ? 50 : sizeMB < 5 ? 30 : sizeMB < 10 ? 2 : 1,
  //   );
  //
  ...
  //
  //   if (kDebugMode) {
  //     print('Input size  : ${sizeMB.toStringAsFixed(2)} MB');
  //     print('Output size : ${(output.sizeInBytes / 1048576).toStringAsFixed(2)} MB');
  //   }
  //
