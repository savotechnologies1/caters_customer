...
class LocationController extends GetxController implements GetxService {
  ...
  Future<AddressModel> getCurrentLocation(bool fromAddress, {GoogleMapController? mapController, LatLng ?defaultLatLng, bool notify = true}) async {
    ...
    isLocationFetched = true; // ✅ ADD HERE
  ...
  void updatePosition(CameraPosition position, bool fromAddress) async {
    if(_updateAddAddressData) {
      ...
      // ✅ BLOCK INVALID LOCATION (THIS FIXES FIRST TIME ISSUE)
  ...
  AddressModel? getUserAddress() {
    AddressModel? _addressModel;
    try {
      String? userAddressString = locationRepo!.getUserAddress();
      if (userAddressString != null && userAddressString.isNotEmpty) {
        _addressModel = AddressModel.fromJson(jsonDecode(userAddressString));
      }
    } catch(e) {
      print('Error getting user address: $e');
    }
    return _addressModel; // Return null if no address found
  }
