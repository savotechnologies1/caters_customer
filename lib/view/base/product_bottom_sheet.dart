...
class _ProductBottomSheetState extends State<ProductBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.only(left: Dimensions.PADDING_SIZE_DEFAULT, bottom: 70),
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  ...
                  Row(children: [
                    QuantityButton(
                      onTap: () {
                        if (productController.quantity > int.parse(widget.product!.qty!)) {       //replace with 1 if any issue
                ...
                Text("Minimum Quantity : ${widget.product!.qty}" , style: TextStyle(fontSize: 12),),
                SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
