...
class ProductView extends StatelessWidget {
  ...
  ProductView({ this.restaurants,  this.products,  this.isRestaurant, this.isScrollable = false,
    ...
    return Column(children: [
      ...
      !_isNull ? _length > 0 ? GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          childAspectRatio: ResponsiveHelper.isDesktop(context) ? 4 : showTheme1Restaurant ? 1.9 : 3.5,
