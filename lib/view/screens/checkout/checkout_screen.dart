                ...
                return GetBuilder<CouponController>(
                  ...
                  return GetBuilder<OrderController>(
                    ...
                    if (restController.restaurant != null &&
                      ...
                      ZoneData _zoneData = Get.find<LocationController>()
                          .getUserAddress()!
                          .zoneData
                          !.firstWhere((data) =>
                      ...
                      if (restController.restaurant!.selfDeliverySystem == 0 &&
                          _zoneData.increasedDeliveryFeeStatus == 1) {
                        _deliveryCharge = _deliveryCharge +
                            (_deliveryCharge *
                                (_zoneData.increasedDeliveryFee! / 100));
                        _charge = _charge +
                            _charge * (_zoneData.increasedDeliveryFee! / 100);
                      }
                      ...
                      if (_restaurantSubscriptionActive) {
                        if (orderController.subscriptionOrder &&
                          ...
                          if (orderController.subscriptionType == 'weekly') {
                            ...
                            _subscriptionQty = DateConverter.getWeekDaysCount(
                                orderController.subscriptionRange!, _weekDays);
                            ...
                            _subscriptionQty = DateConverter.getMonthDaysCount(
                                orderController.subscriptionRange!, _days);
                          } else {
                            _subscriptionQty = orderController
                                                        ...
                                                        Expanded(
                                                          ...
                                                          title:
                                                              'subscription_order'
                                                                  .tr,
                                                          subtitle:
                                                              'place_order_and_enjoy_it_everytime'
                                                                  .tr,
                                                          icon: Images
                                                              .subscription_order,
                                                          isSelected:
                                                                ...
                                                                children: [
                                                                  IconButton(
                                                                      onPressed:
                                                                        ...
                                                                        showDatePicker(
                                                                                context: context,
                                                                                initialDate: deliverDate ?? DateTime.now(),
                                                                  ...
                                                                  Text(deliverDate !=
                                                                          null
                                                                      ? "${deliverDate.day}-${deliverDate.month}-${deliverDate.year}"
                                                                      : "Select Date")
                                                                ],
                                                              ),
                                                            ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              items: orderController.slotIndexList!.map((int value) {
                                                                                return DropdownMenuItem<int>(
                                                                                  ...
                                                                                  child: Text('${DateConverter.dateToTimeOnly(orderController.timeSlots![value].startTime!)} '
                                                                                      '- ${DateConverter.dateToTimeOnly(orderController.timeSlots![value].endTime!)}'),
                                                                                );
                                                                              }).toList(),
                                                                              onChanged: (int? value) {
                                ...
                                child: !orderController.isLoading
                                    ? CustomButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          for (DateTime time
                                              in orderController.selectedDays!) {
                                            if (time != null) {
                                              _datePicked = true;
                                              break;
                                            }
                                          ...
                                          if (!_isCashOnDeliveryActive! &&
                                            ...
                                            showCustomSnackBar(
                                                '${'minimum_order_amount_is'.tr} ${restController.restaurant!.minimumOrder}');
                                                  ...
                                                  .subscriptionOrder &&
                                              orderController.subscriptionRange ==
                                                  null) {
                                            showCustomSnackBar(
                                                'select_a_date_range_for_subscription'
                                                    .tr);
                                          } else if (orderController
                                                  .subscriptionOrder &&
                                              !_datePicked &&
                                            ...
                                            showCustomSnackBar(
                                              ...
                                              !_datePicked) {
                                            showCustomSnackBar(
                                                'select_at_least_one_day_for_subscription'
                                                    .tr);
                                          } else if ((orderController
                                                          .selectedDateSlot ==
                                                      0 &&
                                            ...
                                            for (int index = 0;
                                              ...
                                              carts.add(Cart(
                                                foodId: cart.isCampaign == true ? null : cart.product?.id,
                                                itemCampaignId: cart.isCampaign == true ? cart.product?.id : null,
                                                price: cart.discountedPrice?.toString() ?? '0',
                                                variant: '',
                                                variation: _variations ?? [],
                                                quantity: cart.quantity ?? 1,
                                                addOnIds: _addOnIdList ?? [],
                                                addOns: cart.addOns ?? [],
                                                addOnQtys: _addOnQtyList ?? [],
                                              ));
                                            ...
                                            orderController.placeOrder(
                                                PlaceOrderBody(
                                                  ...
                                                  //     .dateToDateAndTime(
                                                  //     _scheduleStartDate),
                                                  scheduleAt: (restController.restaurant?.scheduleOrder ?? false)
                                                      ? "" // default value if scheduleOrder is true
                                                      : (deliverDate == null)
                                                      ? "" // default if deliverDate is null
                                                      : DateConverter.dateToDateAndTime(_scheduleStartDate) ?? "", // default if converter returns null
                                                  ...
                                                  paymentMethod: orderController
                                                      ...
                                                      : orderController
                                                          ...
                                                          : orderController
                                                              ...
                                                              ? 'wallet'
                                                              : 'digital_payment',
                                                  couponCode: ((Get.find<CouponController>().discount ?? 0) > 0 ||
                                                      (Get.find<CouponController>().coupon != null &&
                                                          (Get.find<CouponController>().freeDelivery ?? false)))
                                                  ...
                                                  subscriptionStartAt: orderController
                                                          .subscriptionOrder
                                                      ? DateConverter
                                                          .dateToDateAndTime(
                                                              orderController
                                                                  ...
                                                                  !.start)
                                                      : '',
                                                  subscriptionEndAt: orderController
                                                          .subscriptionOrder
                                                      ? DateConverter
                                                          .dateToDateAndTime(
                                                              orderController
  ...
  void _callback(bool isSuccess, String message, String orderID, double amount,
    ...
    if (isSuccess) {
      ...
      if (Get.find<OrderController>().paymentMethodIndex == 0 ||
        ...
        print(Get.find<OrderController>().paymentMethodIndex.toString());
        Get.offNamed(
