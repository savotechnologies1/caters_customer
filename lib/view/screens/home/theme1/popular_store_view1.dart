...
class PopularStoreView1 extends StatelessWidget {
  ...
  PopularStoreView1({@required this.isPopular, this.isRecentlyViewed = false});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restaurantController) {
      List<Restaurant> ?_restaurant = isPopular! ? restaurantController.popularRestaurantList : isRecentlyViewed! ? restaurantController.recentlyViewedRestaurantList : restaurantController.latestRestaurantList;
      ...
      return (_restaurant != null && _restaurant.length == 0) ? SizedBox() : Column(
        children: [
          Padding(
            ...
            child: TitleWidget(
               isPopular! ? 'popular_restaurants'.tr : isRecentlyViewed! ? 'recently_viewed_restaurants'.tr : '${'new_on'.tr} ${AppConstants.APP_NAME}',
               () => Get.toNamed(RouteHelper.getAllRestaurantRoute(isPopular! ? 'popular' : isRecentlyViewed! ? 'recently_viewed' : 'latest')),
            ),
          ),
