...
class WebPopularRestaurantView extends StatelessWidget {
  ...
  WebPopularRestaurantView({@required this.isPopular, this.isRecentlyViewed = false});
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restController) {
      ...
      return _restaurantList != null && _restaurantList.isNotEmpty ? Column(
        children: [
          Padding(
            padding: EdgeInsets.fromLTRB(10, 15, 10, 10),
            child: TitleWidget(isPopular! ? 'popular_restaurants'.tr : isRecentlyViewed! ? 'your_restaurants'.tr :  '${'new_on'.tr} ${AppConstants.APP_NAME}',(){}),
          ),

          _restaurantList != null && _restaurantList.isNotEmpty ? GridView.builder(
