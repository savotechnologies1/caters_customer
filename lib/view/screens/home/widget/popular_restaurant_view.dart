      ...
      return (_restaurantList != null && _restaurantList.length == 0) ? SizedBox() : Column(
        children: [
          Padding(
            ...
            child: TitleWidget(
            isPopular! ? 'popular_restaurants'.tr : isRecentlyViewed! ? 'your_restaurants'.tr :  '${'new_on'.tr} ${AppConstants.APP_NAME}',
                ...
                return Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      print('${Get.find<SplashController>().configModel!.baseUrls!.restaurantCoverPhotoUrl}'
