      ...
      builder: (cuisineController) {
        return (cuisineController.cuisineModel != null && cuisineController.cuisineModel!.cuisines!.length == 0) ? SizedBox() : Column(children: [
          Padding(
            ...
            child: TitleWidget('cuisines'.tr,  () => Get.toNamed(RouteHelper.getCuisineRoute())),
          ),
          ...
          Padding(
            ...
            child: cuisineController.cuisineModel != null ? GridView.builder(
                ...
                shrinkWrap: true,
                //todo : Deepak Change count value 10 to 5
                itemCount: ResponsiveHelper.isMobile(context) ? cuisineController.cuisineModel!.cuisines!.length > 8 ? 8 : cuisineController.cuisineModel!.cuisines!.length : ResponsiveHelper.isTab(context) ? 5 : 0,
