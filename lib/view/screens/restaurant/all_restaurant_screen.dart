...
class AllRestaurantScreen extends StatefulWidget {
  ...
  AllRestaurantScreen({@required this.isPopular, @required this.isRecentlyViewed});
...
class _AllRestaurantScreenState extends State<AllRestaurantScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: widget.isPopular! ? 'popular_restaurants'.tr : widget.isRecentlyViewed! ? 'recently_viewed_restaurants'.tr : '${'new_on'.tr} ${AppConstants.APP_NAME}'),
        ...
        child: Scrollbar(child: SingleChildScrollView(child: Center(child: SizedBox(
          ...
          child: GetBuilder<RestaurantController>(builder: (restController) {
            return ProductView(
              ...
              restaurants: widget.isPopular! ? restController.popularRestaurantList : widget.isRecentlyViewed! ? restController.recentlyViewedRestaurantList : restController.latestRestaurantList,
