...
import 'package:efood_multivendor/view/screens/auth/enter_phone_screen.dart';
                ...
                child: Container(
                  ...
                  child: GetBuilder<AuthController>(builder: (authController) {
                    return Column(children: [
                      ...
                      Text('welcome_back'.tr.toUpperCase(),
                      ...
                      TextButton(onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> EnterPhoneScreen()));
