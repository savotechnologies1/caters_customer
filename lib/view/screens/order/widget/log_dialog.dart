                            ...
                            Row(children: [
                              ...
                              Text(
                                DateConverter.dateTimeStringToDateTime(
                                    logData.orderStatus! == 'pending' ? logData.scheduleAt.toString() : logData.orderStatus == 'accepted' ? logData.accepted.toString()
                                    : logData.orderStatus == 'confirmed' ? logData.confirmed.toString() : logData.orderStatus == 'processing' ? logData.processing
