    ...
    return WillPopScope(
      ...
      child: GetBuilder<OrderController>(builder: (orderController) {
        ...
        if (orderController.orderDetails != null && _order != null) {
          ...
          _digitalPay = _order.paymentMethod != 'cash_on_delivery' &&
              _order.paymentMethod != 'takeover';
          ...
          if (_subscription) {
            if (_order.subscription!.type == 'weekly') {
              ...
              for (SubscriptionScheduleModel schedule
                ...
                _schedules.add(
                    '${_weekDays[schedule.day!].tr} (${DateConverter.convertTimeToTime(schedule.time!)})');
              }
              ...
              _schedules.add(DateConverter.convertTimeToTime(
        ...
        return Scaffold(
            ...
            body: (_order != null && orderController.orderDetails != null)
                ? Column(children: [
                          ...
                          child: SizedBox(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                                ...
                                                Center(
                                                  child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        // ),
                                                        Text(
                                                          (_order.restaurant?.deliveryTime != null &&
                                                              _order.createdAt != null &&
                                                              _order.processingTime != null &&
                                                              _order.scheduleAt != null)
                                                              ? (DateConverter.differenceInMinute(
                                                              _order.restaurant!.deliveryTime!,
                                                              _order.createdAt!,
                                                              _order.processingTime!,
                                                              _order.scheduleAt!) <
                                                              5
                                                              ? '1 - 5'
                                                              : '${DateConverter.differenceInMinute(
                                                              ...
                                                              _order.processingTime!,
                                                              _order.scheduleAt!)}')
                                                              : '1 - 5', // fallback if values are missing
                                                          style: robotoBold.copyWith(
                                    ...
                                    Row(children: [
                                      Text(
                                          '${_subscription ? 'subscription_id'.tr : 'order_id'.tr}:',
                                          style: robotoRegular),
                                      SizedBox(
                                          width: Dimensions
                                              .PADDING_SIZE_EXTRA_SMALL),
                                    ...
                                    _cancelled &&
                                            _order.cancellationNote != null &&
                                            _order.cancellationNote != ''
                                        ? Column(
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            children: [
                                                  ...
                                                  onTap: () => Get.dialog(
                                                      ReviewDialog(
                                                          ...
                                                          fromOrderDetails:
                                                              true)),
                                                  child: Text(
                                                    '${_order.cancellationNote != null ? _order.cancellationNote : ''}',
                                                    maxLines: 2,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style:
                    ...
                    !orderController.showCancelled
                        ? Center(
                            child: SizedBox(
                              ...
                              child: Row(children: [
                                ((!_subscription ||
                                            (_order.subscription!.status !=
                                                    'canceled' &&
                                                _order.subscription!.status !=
                                                    'completed')) &&
                                        ((_pending! && !_digitalPay!) ||
                                            _accepted! ||
                                            _confirmed! ||
                                            _processing! ||
                                          ...
                                          onPressed: () {
                                            Get.dialog(ConfirmationDialog(
                                                ...
                                                onYesPressed: () {
                                                  ...
                                                  if (_maxCodOrderAmount ==
                                                          null ||
                                                      _maxCodOrderAmount >
                                                          _total) {
                                                    orderController
                                                        .switchToCOD(_order.id
                                                            .toString())
                                                        .then((isSuccess) {
                                                      Get.back();
                                                      if (isSuccess) {
                    ...
                    !orderController.showCancelled &&
                            _subscription &&
                            (_order.subscription!.status == 'active' ||
                                _order.subscription!.status == 'paused')
                        ? CustomButton(
                            ...
                            onPressed: () async {
                              Get.dialog(SubscriptionPauseDialog(
                                  subscriptionID: _order.subscriptionId,
                                  isPause: true));
                            },
                          )
                        : SizedBox(),
                    ...
                    Builder(builder: (context) {
                      return ((_order.orderStatus == 'failed' || _cancelled!) &&
                              !_cod! &&
                              Get.find<SplashController>()
                                  .configModel!
                                  .cashOnDelivery!)
